...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* الحاوية الرئيسية تمتد على كامل الارتفاع المتاح للمتصفح */
        .app-container { display: flex; flex-direction: column; height: 100%; }
        
        #header { background: #1e293b; padding: 15px; text-align: center; border-bottom: 2px solid #334155; flex-shrink: 0; }
        #header h2 { margin: 0; font-size: 1.3rem; color: #FFD700; text-shadow: 0 0 10px rgba(255,215,0,0.3); }
        
        /* صندوق المحادثة يأخذ المساحة المتبقية ويسمح بالتمرير */
        ...
        /* منطقة الإدخال مثبتة بالأسفل بشكل مضمون */
        #input-area { padding: 12px; background: #1e293b; display: flex; gap: 8px; border-top: 2px solid #334155; flex-shrink: 0; }
        #username { flex: 1; max-width: 90px; padding: 12px; border: 1px solid #475569; border-radius: 8px; background: #0f172a; color: white; font-size: 0.95rem; outline: none; }
        #msg { flex: 3; padding: 12px; border: 1px solid #475569; border-radius: 8px; background: #0f172a; color: white; font-size: 0.95rem; outline: none; }
